...
- [x] 开发环境复核：`uv --version` 确认 0.8.3 可用、`python --version` 确认 3.13.5
- [x] 确认 `C:\work\HuanyuCode\skill-master\` 为实施根目录（当前仅有 docs/）
- [x] 任务 1 建立 pytest 空基线

## 任务列表

### [x] 任务 1: 项目骨架 + pytest 基线 (~3 min)
...
### [x] 任务 3: skill-anatomy.md 知识底座 (~5 min)
...
### [x] 任务 4: security-taxonomy.md 风险分类学 (~5 min)
...
### [x] 任务 5: fixtures — 假 Agent 目录树 (~4 min)
...
### [x] 任务 7: inventory.py — 健康检查 + 重复检测 (~4 min)
...
### [x] 任务 8: sm-manager SKILL.md (~4 min)
...
### [x] 任务 9: fixtures — 恶意 skill 样本 (~5 min)
...
### [x] 任务 11: scanner.py — 评分 + 截断 + CLI (~4 min)
...
### [x] 任务 12: sm-security SKILL.md (~4 min)
...
### [x] 任务 13: templates/report.html (~4 min)
...
### [x] 任务 15: sm-analyzer SKILL.md (~4 min)
...
### [x] 任务 16: references/writing/ 吸收 (~3 min)
...
### [x] 任务 17: references/optimizing/ 吸收 (~4 min)
...
### [x] 任务 18: references/security/ 吸收 (~4 min)
...
### [x] 任务 19: sm-writer SKILL.md (~5 min)
...
### [x] 任务 20: sm-optimizer SKILL.md (~5 min)
