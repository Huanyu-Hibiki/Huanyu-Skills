...
## 前置
1. 读 `C:/work/Huanyu Hub/Huanyu-Knowledge/personal/阅读笔记/YYYY-MM/<书名>/问题清单.md`（#3 的锚定问题+预期收获，用于诊断达成度）。
2. 读 `C:/work/Huanyu Hub/Huanyu-Knowledge/personal/阅读笔记/YYYY-MM/<书名>/00-拆解目录.md`（章节范围）。
3. 读 Hub 取核心目标+应用场景。
...
## 输出：C:/work/Huanyu Hub/Huanyu-Knowledge/personal/阅读笔记/YYYY-MM/<书名>/知识卡片.md
