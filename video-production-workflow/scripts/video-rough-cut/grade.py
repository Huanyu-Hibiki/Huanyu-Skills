...
Usage:
    python scripts/video-rough-cut/grade.py <input> -o <output>                   # auto mode
    python scripts/video-rough-cut/grade.py <input> -o <output> --preset warm_cinematic
    python scripts/video-rough-cut/grade.py <input> -o <output> --filter 'eq=contrast=1.1'
    python scripts/video-rough-cut/grade.py --print-preset warm_cinematic         # print filter only
    python scripts/video-rough-cut/grade.py --analyze <input>                     # print auto-grade analysis
