...
def generate_shot_brief(sentence: Dict[str, Any], style_pack: str = "vox_explainer",
    ...
    shot_brief = {
        ...
        "main_visual": {
            ...
            "subject": props.get("title", "narrative process"),
        },
        "composition": {
            "layout": "split_frame_editorial",
            "safe_area": {"x": 0.06, "y": 0.08, "w": 0.88, "h": 0.84},
            "face_avoidance_zone": th_zone,
        },
        "entrance": {"semantic": "attention_reveal", "duration": 0.45},
        "exit": {"semantic": "make_room", "duration": 0.35},
        "acceptance_frames": [0.0, 0.5, 0.96],
        "source": {"type": "a_roll_sentence", "id": sent_id},
        "provenance": {"generator": "broll_narrative", "template_id": tmpl["id"]},
        "layer": "B-roll Packaging",
        "start": target_start,
        "end": round(target_start + shot_dur, 6),
