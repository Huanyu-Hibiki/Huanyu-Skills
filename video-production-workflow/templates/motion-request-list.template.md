...
| 请求 ID | 对应镜号 / 时间 | A-roll 状态 | 目的 | 内容 | 类型 | 时长 | 分辨率 / FPS | 透明通道 | 推荐引擎 | 数据 / 文案 | 优先级 | 状态 |
|---|---|---|---|---|---|---:|---|---|---|---|---|---|
| MOTION-001 | `<EP001-S08 / 02:05-02:35>` | `<OBS 保留>` | 解释 | `<产品能力对比>` | `<流程 / 数据 / UI / 关键词>` | 6 | `1920x1080@30` | 是 | Remotion | `<props/data>` | 高 | approved |
