...
TASK_READLIST = {
    ...
    "cover": [
        "目标作品 scripts/*.md（定稿）",
        "user-profile.md（形象三词 / 风格）",
        "cover-patterns.md（如有，对标视觉配方）",
        "references/cover-generation-protocol.md 或 cover-analysis-protocol.md（按 mode 选择）",
    ],
    ...
    "study": ["study/<对象>/samples/<content-id>/（共享素材归档）", "benchmark.md / script_patterns.md / techniques.md（按模式读取）"],
